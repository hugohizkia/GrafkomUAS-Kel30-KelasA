...
namespace GrafkomUAS
{
    class Windows : GameWindow
    {
        ...
        private Vector3 specularlight = new Vector3(1f, 1f, 1f);
        private Vector3 spotligh = new Vector3(0.0f, 0.0f, 0.0f);
        private bool flash;
        private bool gelap = false;
        ...
        protected override void OnLoad()
        {
            ...
            lights.Add(new PointLight(new Vector3(-1.23f, 1.4554096f, -0.020166561f), new Vector3(0.0f, 0.0f, 0.0f),
                new Vector3(1.0f, 1.0f, 1.0f), new Vector3(1.0f, 1.0f, 1.0f), 0.5f, 0.5f, 0.5f));

            /*lights.Add(new PointLight(new Vector3(4f, 1.4554096f, -0.020166561f), new Vector3(0.05f, 0.05f, 0.05f),
                new Vector3(1.0f, 1.0f, 1.0f), new Vector3(1.0f, 1.0f, 1.0f), 0.5f, 0.5f, 0.5f));*/


            lights.Add(new DirectionLight(new Vector3(0f, 0f, 0f), new Vector3(0.05f, 0.05f, 0.05f),
                new Vector3(1.0f, 1.0f, 1.0f), new Vector3(1.0f, 1.0f, 1.0f), new Vector3(-1f, -1f, 0f)));

            //lights.Add(new DirectionLight())

            //Initialize Mesh here
            mesh0 = LoadObjFile("../../../Resources/latar.obj");
            mesh0.setupObject(1.0f, 1.0f);
            mesh0.translate(new Vector3(3f, 0f, 0f));
            mesh0.scale(0.7f);


            mesh1 = LoadObjFile("../../../Resources/kantor.obj");
            mesh1.setupObject(1.0f, 1.0f);
            mesh1.translate(new Vector3(0f, 0f, 0f));
            mesh1.scale(0.05f);

            mesh2 = LoadObjFile("../../../Resources/penjahat1.obj");
            mesh2.setupObject(1.0f, 1.0f);
            mesh2.translate(new Vector3(2f, 0f, -2f));
            mesh2.scale(1.5f);

            mesh3 = LoadObjFile("../../../Resources/penjahat2.obj");
            mesh3.setupObject(1.0f, 1.0f);
            mesh3.translate(new Vector3(2.5f, 0f, 0f));
            mesh3.scale(1.5f);

            mesh5 = LoadObjFile("../../../Resources/polisi2.obj");
            mesh5.setupObject(1.0f, 1.0f);
            mesh5.translate(new Vector3(0f, 0f, -14f));
            mesh5.scale(0.41f);
            mesh5.rotate(0f, 180f, 0f);
            _objectPos = mesh5.getTransform().ExtractTranslation();

            mesh6 = LoadObjFile("../../../Resources/jail.obj");
            mesh6.setupObject(1.0f, 1.0f);
            mesh6.translate(new Vector3(0.55f, 0f, 0f));
            mesh6.scale(7f);

            mesh7 = LoadObjFile("../../../Resources/lamp.obj");
            mesh7.setupObject(1.0f, 1.0f);
            mesh7.translate(new Vector3(-0.36f, 1.05f, 1.23f));
            mesh7.scale(1f);
            mesh7.rotate(0f, -90f, 0f);

           /* mesh0.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh1.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh2.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh3.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh5.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh6.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight,
                    1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));
            mesh7.setSpotLight(_camera.Position, _camera.Front, lightcolor, spotligh, specularlight, 1.0f, 0.09f, 0.032f, MathF.Cos(MathHelper.DegreesToRadians(12.5f)), MathF.Cos(MathHelper.DegreesToRadians(12.5f)));*/

            var _cameraPosInit = new Vector3(0, 1f, 7f);
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            if (postprocessing)
            {
                ...
                for (int i = 0; i < lights.Count; i++)
                {
                    ...
                    mesh6.calculateTextureRender(_camera, lights[i], i);
                    mesh7.calculateTextureRender(_camera, lights[i], i);
                }
        ...
        protected override void OnUpdateFrame(FrameEventArgs args)
        {
            ...
            if (KeyboardState.IsKeyReleased(Keys.Q))
            {
                if (gelap)
                {
                    gelap = false;
                    ...
                    spotligh = new Vector3(0.0f, 0.0f, 0.0f);
                }
                else
                {
                    gelap = true;
                    ...
                    spotligh = new Vector3(1.0f, 1.0f, 1.0f);
                }
            }
            ...
            if (KeyboardState.IsKeyDown(Keys.W))
            {
                ...
                _camera.Position = new Vector3(vec.X, vec.Y + 1.5f, vec.Z + 1.5f);
